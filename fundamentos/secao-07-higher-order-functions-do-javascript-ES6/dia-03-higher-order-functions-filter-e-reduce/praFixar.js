...
// filter e reduce 
const sumFilterReduce = numbers.filter((num) => num % 2 === 0).reduce((acc, curr) => acc + curr);
// só reduce
const sumReduce = numbers.reduce((acc, num) => num % 2 === 0 ? acc + num : acc);

console.log(sumFilterReduce, sumReduce);
